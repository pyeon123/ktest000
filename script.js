...
function initMenu() {
    ...
    const fileMapping = {
        "cat_01": "family.html", "cat_02": "food.html", "cat_03": "places.html", "cat_04": "transport.html",
        "cat_05": "animals.html", "cat_06": "clothes.html", "cat_07": "nature.html", "cat_08": "hobbies.html",
        "cat_09": "body.html", "cat_10": "Jobs.html", "cat_11": "emotions.html", "cat_12": "kitchen.html",
        "cat_13": "electronics.html", "cat_14": "health.html", "cat_15": "fruits.html", "cat_16": "colors.html",
        "cat_17": "school.html", "cat_18": "time.html", "cat_19": "sports.html", "cat_20": "furniture.html",
        "cat_21": "buildings.html", "cat_22": "landscapes.html", "cat_23": "word.html", "cat_24": "vocabulary.html",
    };
...
// ===================================================================
// 🔥 [새로운 글로벌 eSIM 광고 엔진 교체 구간]
// ===================================================================

const globalDestinations = [
    { country: "Japan", emoji: "🇯🇵", bg: "#ffe4e6", border: "#f43f5e", text: "#9f1239" },
    { country: "Thailand", emoji: "🇹🇭", bg: "#ecfeff", border: "#06b6d4", text: "#155e75" },
    { country: "Indonesia", emoji: "🇮🇩", bg: "#fff1f2", border: "#fda4af", text: "#9f1239" },
    { country: "Vietnam", emoji: "🇻🇳", bg: "#fef2f2", border: "#ef4444", text: "#991b1b" },
    { country: "USA", emoji: "🇺🇸", bg: "#eff6ff", border: "#3b82f6", text: "#1e3a8a" },
    { country: "Canada", emoji: "🇨🇦", bg: "#fff5f5", border: "#f87171", text: "#9b1c1c" },
    { country: "UK", emoji: "🇬🇧", bg: "#f8fafc", border: "#64748b", text: "#0f172a" },
    { country: "France", emoji: "🇫🇷", bg: "#f0fdf4", border: "#4ade80", text: "#14532d" },
    { country: "Germany", emoji: "🇩🇪", bg: "#fefce8", border: "#eab308", text: "#451a03" },
    { country: "Greece", emoji: "🇬🇷", bg: "#f0f9ff", border: "#0ea5e9", text: "#0369a1" },
    { country: "Brazil", emoji: "🇧🇷", bg: "#f0fdf4", border: "#22c55e", text: "#166534" }
];
...
let isKoreaTurn = true;
let lastCountryIdx = -1;

setInterval(() => {
    const container = document.getElementById("esim-ad-container");
    const flagEl = document.getElementById("ad-flag");
    ...
    if (isKoreaTurn) {
        currentData = koreaDestination;
        contentEl.innerText = "Get Korea eSIM - Instant Data! 🚀";
    } else {
        let randomIdx;
        do {
            randomIdx = Math.floor(Math.random() * globalDestinations.length);
        } while (randomIdx === lastCountryIdx && globalDestinations.length > 1);
        
        lastCountryIdx = randomIdx;
        currentData = globalDestinations[randomIdx];
        contentEl.innerText = `Get ${currentData.country} eSIM - Travel Stress-Free! ✨`;
    }

    container.style.animation = 'none';
    container.offsetHeight; 
    container.style.animation = 'fadeMove 0.4s ease-out';
    
    container.style.background = currentData.bg;
    container.style.borderColor = currentData.border;
    contentEl.style.color = currentData.text;
    
    if (flagEl) {
        flagEl.innerText = currentData.emoji;
    }

    isKoreaTurn = !isKoreaTurn;
